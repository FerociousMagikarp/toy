...
struct node_traits<container_node<Val, Base...>, KeyOfVal, N>
{
    ...
    constexpr static base_ptr cast_to_base(node_ptr node) noexcept
    {
    ...
    constexpr static const_base_ptr cast_to_base(const_node_ptr node) noexcept
    {
    ...
    constexpr static node_ptr cast_to_node(base_ptr base) noexcept
    {
        using index_ptr = _node_base_index<N, base_type>*;
    ...
    constexpr static const_node_ptr cast_to_node(const_base_ptr base) noexcept
    {
        using const_index_ptr = const _node_base_index<N, base_type>*;
    ...
    constexpr static void* value_addr(base_ptr base) noexcept { return cast_to_node(base)->value_addr(); }
    constexpr static const void* value_addr(const_base_ptr base) noexcept { return cast_to_node(base)->value_addr(); }
    constexpr static Val* value_ptr(base_ptr base) noexcept { return cast_to_node(base)->value_ptr(); }
    constexpr static const Val* value_ptr(const_base_ptr base) noexcept { return cast_to_node(base)->value_ptr(); }

    constexpr static const auto& get_key(const_base_ptr base)
        noexcept(noexcept(KeyOfVal(std::declval<value_type>())))
    { return KeyOfVal(*value_ptr(base)); }
    constexpr static const auto& get_key(value_type&& val)
        noexcept(noexcept(KeyOfVal(std::declval<value_type>())))
    { return KeyOfVal(std::forward<value_type>(val)); }
    constexpr static const auto& get_key(const value_type& val)
        noexcept(noexcept(KeyOfVal(std::declval<value_type>())))
    { return KeyOfVal(val); }
};
